...
const Invoice = () => {
  ...
  return (
    <>
      {addClientMode && (
        <AddCompany
          display={addClientMode}
          setDisplay={setAddClientMode}
      ...
      {pdfPreviewMode ? (
        <Pdfdata
          ...
          setPdfPreviewMode={setPdfPreviewMode}
        />
      ) : (
        <div
          style={
            addClientMode ? { filter: "blur(5px)" } : { filter: "blur(0px)" }
          }
        >
            ...
            <div className="invoice-upper-col1">
              <div className="invoice-upper-col1-row1">
                <div className="row1-dropdown-div">
                  ...
                  <div className="dropdown-div">
                    <select
                      ...
                      id="dropdown"
                      onChange={(e) =>
                        setPdfData({ ...pdfData, client: e.target.value })
                      }
                    >
                ...
                <div className="input-div">
                  ...
                  <input
                    type="text"
                    placeholder="Seperate emails with comma"
                    onChange={(e) =>
                      setPdfData({ ...pdfData, clientEmail: e.target.value })
                    }
                  />
                </div>
                <div className="input-checkbox-div input-checkbox-div2">
                  <input
                    type="checkbox"
                    onChange={(e) =>
                      setPdfData({ ...pdfData, send: e.target.checked })
                    }
                  />
                  <p>Send</p>
                </div>
              ...
              <div className="invoice-upper-col1-row1 invoice-upper-col1-row2">
                ...
                <div className="input-div">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPdfData({ ...pdfData, terms: e.target.value })
                    }
                  />
                </div>
                <div className="input-div">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPdfData({ ...pdfData, invoiceDate: e.target.value })
                    }
                  />
                </div>
                <div className="input-div">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPdfData({ ...pdfData, dueDate: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="invoice-upper-col2">
              ...
              <div className="input-div">
                ...
                <input
                  ...
                  placeholder="2700"
                  onChange={(e) =>
                    setPdfData({ ...pdfData, invoiceNo: e.target.value })
                  }
                />
              </div>
            </div>
              ...
              <div className="form-row-col1">
                <div className="textarea-div1">
                  ...
                  <textarea
                    ...
                    rows="10"
                    onChange={(e) =>
                      setPdfData({ ...pdfData, messege: e.target.value })
                    }
                  ></textarea>
                </div>
              </div>
